package com.hfjy.eureka.gateway.jjwt;
...
public class JwtUtil {
    ...
    public static UserInfo parseJWT(String jwt) {
        ...
        return new UserInfo(claims.get("userId", Integer.class), claims.get("userName", String.class));
    }

    public static void main(String[] args) {
        String token = JwtUtil.createJWT("id","issuer","subject",2000000l);
